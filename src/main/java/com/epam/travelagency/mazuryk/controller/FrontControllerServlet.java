package com.epam.travelagency.mazuryk.controller;

import com.epam.travelagency.mazuryk.commands.CommandResponse;
import com.epam.travelagency.mazuryk.commands.FrontCommand;
    ...
    private FrontCommand getCommand(HttpServletRequest request) {
        try {
            Class type = Class.forName(String.format(
                    "com.epam.travelagency.mazuryk.commands.%sCommand",
